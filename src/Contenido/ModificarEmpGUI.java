...
public class ModificarEmpGUI extends JFrame {
    ...
    public ModificarEmpGUI() {
        ...
        JLabel lblNit = new JLabel("NIT de la empresa a modificar:");
        lblNit.setFont(font);
        ...
        comboFields = new JComboBox<>(new String[]{
            "Razón Social", "Ciudad", "Dirección", "Nombre del Contacto"
        });
        ...
        btnUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fieldDb != null) {
                    try {
                        String query = "UPDATE EMPRESA SET " + fieldDb + " = ? WHERE E_NIT = ?";
                        try (PreparedStatement statement = connection.prepareStatement(query)) {
                            statement.setString(1, newValue); // Asignar el nuevo valor para el campo
                            statement.setInt(2, nit); // Asignar el NIT de la empresa
                            ...
                            if (rowsUpdated > 0) {
                                ...
                                lblStatus.setText("No se encontró una empresa con el NIT ingresado.");
                                lblStatus.setForeground(Color.RED);
                            }
                        }
    ...
    private String getFieldDbName(String field) {
        switch (field) {
            ...
            case "Nombre del Contacto": return "Nombre_Contacto";
            default: return null;
        }
    }
